    ...
    <div id="bs-navbar" class="navigation d-none d-md-block">
      ...
      <div class="navbar-dark mainMenu" id="main_menu_container">
        <!-- Items menú principal -->
         <div class="btn-group">
          <a href="../../../vistas/html/inicioAdmin.php" aria-label="Enlace para ir a inicio" class="btn btn-default">Inicio</a>
        </div>
         <div class="btn-group">
          <a href="../../../vistas/html/inicio.php" aria-label="Enlace para ir a inicio" class="btn btn-default">Perfil usuario</a>
        </div>
        <div class="btn-group">
          <a href="../../../vistas/html/gestionUsuarios.php"   aria-label="Enlace para contactar a nuestro equipo" class="btn btn-default">Gestión de usuarios</a>
        </div>
         <div class="btn-group">
          <a href="../../../vistas/html/actualizarAdmin.php"   aria-label="Enlace para ir actualizar los datos "class="btn btn-default">Actualizar Datos</a>
        </div>
        <div class="btn-group">
          <a href="../../../vistas/html/reporteAdmin.php"  aria-label="Enlace para ver los reportes" class="btn btn-default">Ver reportes</a>
        </div>
